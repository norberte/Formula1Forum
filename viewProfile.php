		...
		<div id="centercolumn">
		  <div id="centercolumn_2">
			<?php
					...
					if($error != null){
						echo "<p>Error - page not working</p>";
					} else {
						try{
							if (isset( $_SESSION['username'] )){
			...
			<div class="card">
				...
				<div class="name"><p><a href="#"><?php echo $userName ?></a></p></div>
				<div class="numbers">
					<table id="stats">
						<tbody>
							<tr>
				...
				<button class="primaryButton"><a href="editProfile.php">Edit Profile</a></button>
			</div>
			<!-- End of News Box 2 -->
		  </div>
		</div>
